# Generated by Django 3.1 on 2021-06-29 13:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'Формаируется'), ('STP', 'Отправлен в обработку'), ('PRD', 'Обработан'), ('PD', 'Оплачек'), ('RD', 'Готов к выдаче'), ('CNC', 'Отменён'), ('DVD', 'Выдан')], default='FM', max_length=3, verbose_name='статус')),
